...
const SuggessionsArray=['American','Andorra','Angola','Belgium','BelizeBenin','Bermuda','Cambodia','Cameroon','Canada','Denmark','Djibouti','Dominica','Dominican Republic',
...
'RomaniaRussian ','Federation','Sri Lanka','Switzerland','Taiwan','United Kingdom','United States of America','Vanuatu','Wallis and Futuna Islands','Yemen','Zambia','Zimbabwe']
            ...
            if(searchval.length>0)
                    {
                        suggest=SuggessionsArray.sort().filter((e) => e.toLowerCase().includes(searchval.toLowerCase()))
